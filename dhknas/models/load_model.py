...
from .DHSpace import DHSpace, DHNet, DHSpaceKAA
...
def load_pre_post(args, dataset):
    ...
    if args.dataset == "Aminer":
        ...
        from dhknas.trainer.nreg import NodePredictor
                ...
                if model == "DHSpace":
                    ...
                    dhspaces.append(
                        DHSpaceKAA(
                            ...
                            norm=norm,
                            args=args,
                        ).assign_basic_arch(["causal", "node_hetero", "kaa"])  # 添加kaa架构
                    )
